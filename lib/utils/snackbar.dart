...
class Snackbar {
  ...
  static show(ABC abc, String msg, {required bool success}) {
    final snackBar = success
        ? SnackBar(content: Text(msg), backgroundColor: const Color.fromARGB(255, 160, 197, 130))
        : SnackBar(content: Text(msg), backgroundColor: const Color.fromARGB(255, 184, 117, 113));
